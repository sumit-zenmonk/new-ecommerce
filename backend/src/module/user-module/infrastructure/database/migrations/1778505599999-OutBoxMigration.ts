...
export class outboxMigration1778505599999 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "user_schema"."outbox_routing_key_enum" AS ENUM('user.registered','order.created','order.paid','order.status.changed','order.paid.stock.deduct','order.returned')`);
